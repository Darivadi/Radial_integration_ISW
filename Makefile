...
CFLAGS          = -c -O3 -I$(HOME)/local/include/ -I/usr/include/  -DCOMPLETERAY
CFLAGSFROM90MPC = -c -O3 -I$(HOME)/local/include/ -I/usr/include/ -DFROM
CFLAGSUNTIL     = -c -O3 -I$(HOME)/local/include/ -I/usr/include/ -DUNTIL
